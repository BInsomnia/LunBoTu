...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
       Toast.makeText(MainActivity.this, "你点击了轮播图！！！", Toast.LENGTH_LONG).show();
    ...
    private void initEvent() {
        ...
        imageInfoList.add(new ImageInfo(1, "图片1，公告1啦啦啦啦，陆欢博客",  "http://d.hiphotos.baidu.com/image/pic/item/6159252dd42a2834a75bb01156b5c9ea15cebf2f.jpg"));
        imageInfoList.add(new ImageInfo(1, "图片2，公告2啦啦啦啦，陆欢博客",  "http://c.hiphotos.baidu.com/image/h%3D300/sign=cfce96dfa251f3dedcb2bf64a4eff0ec/4610b912c8fcc3ce912597269f45d688d43f2039.jpg"));
        imageInfoList.add(new ImageInfo(1, "图片3，公告3啦啦啦啦，陆欢博客",  "http://e.hiphotos.baidu.com/image/pic/item/6a600c338744ebf85ed0ab2bd4f9d72a6059a705.jpg"));
        imageInfoList.add(new ImageInfo(1, "图片4，公告4啦啦啦啦，陆欢博客",  "http://b.hiphotos.baidu.com/image/h%3D300/sign=8ad802f3801001e9513c120f880e7b06/a71ea8d3fd1f4134be1e4e64281f95cad1c85efa.jpg"));
        imageInfoList.add(new ImageInfo(1, "图片5，公告5啦啦啦啦，陆欢博客",  "http://e.hiphotos.baidu.com/image/h%3D300/sign=73443062281f95cab9f594b6f9177fc5/72f082025aafa40fafb5fbc1a664034f78f019be.jpg"));
    ...
    private void initView() {
        ...
        mTvPagerTitle = findViewById(R.id.tv_pager_title);//标题
        mLineLayoutDot = findViewById(R.id.lineLayout_dot);//轮播圆点
    }
    ...
    private void imageStart() {
        ...
        String[] titles = new String[imageInfoList.size()];//创建图片数据数组
        List<SimpleDraweeView> simpleDraweeViewList = new ArrayList<>();

        for (int i = 0; i < imageInfoList.size(); i++) {
            titles[i] = imageInfoList.get(i).getTitle(); //获取集合数组标题
            SimpleDraweeView simpleDraweeView = new SimpleDraweeView(this);
            simpleDraweeView.setAspectRatio(1.78f);
            //设置一张默认的图片
            GenericDraweeHierarchy hierarchy = new GenericDraweeHierarchyBuilder(this.getResources()).setPlaceholderImage(ContextCompat.getDrawable(this, R.drawable.defult), ScalingUtils.ScaleType.CENTER_CROP).build();
            ...
            simpleDraweeView.setOnClickListener(this);//点击轮播图触发事件
